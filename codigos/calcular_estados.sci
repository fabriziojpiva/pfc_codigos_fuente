...
clear all;
close;
//DIR = get_absolute_file_path("calcular_estados.sci") ;
//DIR="/media/pablo/Pablo/5/PFC/pfc_codigos/";
//load("/media/pablo/Pablo/5/PFC/pfc_codigos/mallas.sod");
//load( DIR +"funciones.sci");
//load("/media/pablo/Pablo/5/PFC/pfc_codigos/funciones.sci")
...
// Luego, se comienza el proceso de determinación de pertenencia a algún elemento de la malla conocida.
        ...
        if(verificacion==1)
            ...
            estados(i,2:$)=interpolar(punto,X,valores);
        end
    end
endfunction
